...
//#endif
    ...
    IMGUI_API bool          CustomButton(const char* label, const char* text, float sizeX, float sizeY);
    IMGUI_API bool          CustomInvisibleButton(const char* label, const char* text, float sizeX, float sizeY);
