...
namespace ImGui
{
    ...
    inline void RenderCustomDraw() {
        ImGui::GetForegroundDrawList()->AddRectFilledMultiColor(
            ImGui::GetWindowPos() + ImVec2(ImGui::GetWindowSize().x / 2, 0),
            ImGui::GetWindowPos() + ImVec2(ImGui::GetWindowSize().x / 2 + 92, ImGui::GetWindowSize().y),
        ...
        ImGui::GetForegroundDrawList()->AddRectFilledMultiColor(
            ...
            ImGui::GetWindowPos() + ImVec2(ImGui::GetWindowSize().x / 2, ImGui::GetWindowSize().y),
            ImColor(0, 0, 0, 0),
            ImColor(139, 119, 185, 40),
            ImColor(139, 119, 185, 40),
            ImColor(0, 0, 0, 0)
