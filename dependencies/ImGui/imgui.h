...
namespace ImGui
{
    ...
    IMGUI_API void          SeparatorText2(const char* label, float thickness = 1.0f);    // separator with text label on the left, followed by a horizontal line
    ...
    IMGUI_API bool          CustomButtonSingle(const char* label, bool* v);

    IMGUI_API void DrawHeaderGradient(ImDrawList* draw, ImVec2 windowPos, ImVec2 windowSize, float headerHeight, const char* label); // brah
    ...
    IMGUI_API bool          CustomInputInt(const char* label, const char* hint, int* v, int step, int step_fast, ImGuiInputTextFlags flags, float sizeX);
    IMGUI_API bool          InputInt2(const char* label, int v[2], ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputInt3(const char* label, int v[3], ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputInt4(const char* label, int v[4], ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputDouble(const char* label, double* v, double step = 0.0, double step_fast = 0.0, const char* format = "%.6f", ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_step = NULL, const void* p_step_fast = NULL, const char* format = NULL, ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          CustomInputScalar(const char* label, const char* hint, ImGuiDataType data_type, void* p_data, const void* p_step, const void* p_step_fast, const char* format, ImGuiInputTextFlags flags, float sizeX);
    IMGUI_API bool          CustomSliderFloat2(const char* label, float v[2], float v_min, float v_max, const char* format = "%.3f"); // osamason bih bih bih
    ...
    IMGUI_API void TabDivider(const char* text);
